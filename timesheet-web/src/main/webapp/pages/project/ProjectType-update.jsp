...
<form class="form-horizontal">
	...
	<input type="hidden" id="isAvailableID" name="isAvailable" />
	<input type="hidden" id="createDateID" name="createDate" />
	<input type="hidden" id="creatorIdID" name="creatorId" />
	<input type="hidden" id="modifierIdID" name="modifierId" />
	<input type="hidden" id="modifyDateID" name="modifyDate" />
