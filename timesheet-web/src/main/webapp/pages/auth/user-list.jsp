		    ...
		    initGridPanel: function(){
		         ...
		         var getButtons = function() {
                    return [{
                        ...
                        content : '<ks:hasSecurityResource identifier="importQuery"><button class="btn btn-primary" type="button"><span class="glyphicon glyphicon-plus"></span>&nbsp;批量导入&nbsp;</button></ks:hasSecurityResource>',
                        action : 'import'
                    }];
		 		};
		         return $('[data-role="userGrid"]').off().grid({
                    ...
                    'grantPermissionToUser' : function(event, data){
                     ...
                     'import' : function(event, data){
                         ...
                         mark = openTab('${pageContext.request.contextPath}/pages/auth/user-import.jsp', "导入用户", mark);
                     }
				});
		    }
		};
