...
public class EmployeeUserController {
    ...
    @ResponseBody
    @RequestMapping("/getEmployeeUser")
    public Page<EmployeeUserDTO>  pagingQuery(int page,int pagesize){
    	return securityOrgAccessFacade.getEmployeeUser(page,pagesize);
    }
}
